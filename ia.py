...
class IA:
    ...
    def get_next_move(self, snake, fruit):
        # Obtenez la direction de la tête du serpent vers la pomme
        to_fruit = fruit.pos - snake.body[0]

        # Choisissez la direction en fonction de la position relative de la pomme
        if to_fruit.x > 0:
            ...
            # Si la tête est déjà sur la pomme, choisissez une direction aléatoire
